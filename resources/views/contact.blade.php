...
@section('main_page-section')
    <div class="container-fluid py-5 set_img"
        style="background-image: url('{{ asset('image/Contact_us_bg.png') }}'); min-height: 100vh;"
        ...
        <div class="row" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
            <div class="col-sm-7 p-3 ">
                ...
                <form class="p-5  box mb-5" method="get">
                    <h2 class="fw-bold root py-3">Send Us Email</h2>
                    ...
                    <div class="row d-flux justify-content-center ">
                        ...
                        <div class="form-group col-sm-5 mb-4 col-sm-6"> <input type="number"
                    ...
                    <div class="row">
                        <button type="submit" class="btn btn-outline  btn-lg col-sm-5  mb-3 m-auto text-secondary fw-bold"
            ...
            <div class="col-sm-5 py-5">
                <h2 class="fw-bold root mt-4">Get in touch with us</h2>
