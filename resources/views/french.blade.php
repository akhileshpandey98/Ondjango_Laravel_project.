...
<body>
            ...
            <div class="col-sm-5  mt-2">
                <div div class="col-sm-6 ">
                    <a class="navbar-brand" href="{{ '/' }}"> <img src="image\logo.png"
                            class="img-fluid w-100 ps-4 d-block" alt="logo" min-height="20vh;" /> </a>
                </div>
            </div>
            {{-- buttom --}}
    ...
    <div class="container-fluid" style="transform: translateY(-50px);">
        {{-- Business --}}
        <div class="row set_img set_img" style="background-image: url('{{ asset('image/lag_franch.png') }}');"
            class="img-fluid w-100">

            <div class="row  mb-5">
                <div class="mt-5">
                    <p class="display-2 fw-bold text-center text-light">French</p>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card text-white mb-5 m-auto"
                        ...
                        <img src="{{ asset('image\l_french.png') }}" class="card-img " alt="..."
                            style="">
