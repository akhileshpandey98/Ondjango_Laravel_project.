...
<body>
    ...
    <div class="container-fluid" style="transform: translateY(-50px);">
        {{-- Business --}}
        <div class="row set_img set_img" style="background-image: url('{{ asset('image/lag_spanish.png') }}');"
            class="img-fluid w-100">

            <div class="row  mb-5">
                <div class="mt-5">
                    <p class="display-2 fw-bold text-center text-light">Spanish</p>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card text-white mb-5 m-auto"
                        ...
                        <img src="{{ asset('image\l_spanish.png') }}" class="card-img " alt="..."
                            style="">
